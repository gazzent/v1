...
wget -O /etc/pam.d/common-password "https://$hosting/Autoscript-by-azi-main/Insshws/password.txt"
...
wget -O /etc/nginx/nginx.conf "https://$hosting/Autoscript-by-azi-main/configuration/nginx.conf"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw https://$hosting/Autoscript-by-azi-main/udpgw/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://$hosting/Autoscript-by-azi-main/udpgw/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://$hosting/Autoscript-by-azi-main/udpgw/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://$hosting/Autoscript-by-azi-main/udpgw/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget https://$hosting/Autoscript-by-azi-main/security/dosflate.zip
unzip dosflate.zip
