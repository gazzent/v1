...
wger -q -O /usr/bin/tendang "https://raw.githubusercontent.com/gazzent/v1/main/limit/tendang.sh"
...
wget -q -O /etc/slowdns/server.key "https://raw.githubusercontent.com/gazzent/v1/main/SLDNS/server.key"
wget -q -O /etc/slowdns/server.pub "https://raw.githubusercontent.com/gazzent/v1/main/SLDNS/server.pub"
wget -q -O /etc/slowdns/sldns-server "https://raw.githubusercontent.com/gazzent/v1/main/SLDNS/sldns-server"
wget -q -O /etc/slowdns/sldns-client "https://raw.githubusercontent.com/gazzent/v1/main/SLDNS/sldns-client"
cd
