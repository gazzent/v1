...
echo -e " ${CYAN}[${BIWhite}01${BICyan}]${RED} •${NC} ${CYAN}MENU SSH WS     $NC  ${CYAN}[${BIWhite}06${BICyan}]${RED} • ${NC}${CYAN}MENU TRIAL$NC"
echo -e " ${CYAN}[${BIWhite}02${BICyan}]${RED} •${NC} ${CYAN}MENU VMESS      $NC  ${CYAN}[${BIWhite}07${BICyan}]${RED} • ${NC}${CYAN}CEK INFO RUNNING$NC"
echo -e " ${CYAN}[${BIWhite}03${BICyan}]${RED} •${NC} ${CYAN}MENU VLESS      $NC  ${CYAN}[${BIWhite}08${BICyan}]${RED} • ${NC}${CYAN}SETTING SC $NC"
echo -e " ${CYAN}[${BIWhite}04${BICyan}]${RED} •${NC} ${CYAN}MENU TOJAN      $NC  ${CYAN}[${BIWhite}09${BICyan}]${RED} • ${NC}${CYAN}MENU BOT PANEL$NC"
echo -e " ${CYAN}[${BIWhite}05${BICyan}]${RED} •${NC} ${CYAN}S-SOCK MENU     $NC  ${CYAN}[${BIWhite}10${BICyan}]${RED} • ${NC}${CYAN}FIX UDP JIKA OFF $NC" 

echo -e "${GREEN}└──────────────────────────────────────────────────┘${NC}"

echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"

echo -e "${GREEN}|\E[44;1;39m                  °SCRIPT MODZ🔥°                \E[0m|"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
echo -e "${GREEN}│ ${BOLD}${LIGHT}👉VERSION    = V 1.3 MOD SCRIPT                         ${NC}"
