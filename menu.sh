...
echo -e "${YELLOW}• Current Domain      = $( cat /etc/xray/domain )"
echo -e "${YELLOW}• Server IP           = $MYIP"
echo -e "${YELLOW}• ISP                 = $(curl -s ipinfo.io/org | cut -d " " -f 2-10 )${NC}"
echo -e "${YELLOW}• Status Hari ini     = $(cat /root/status)${NC}"
echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
