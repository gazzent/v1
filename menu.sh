...
echo -e "${PURPLE}| \E[44;1;39m        SCRIPT PREMIUM BY KINGSTORES        \E[0m |"
echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "${BLUE}• Server Uptime       = $( uptime -p  | cut -d " " -f 2-10000 ) " 
echo -e "${BLUE}• Current Time        = $( date -d "0 days" +"%d-%m-%Y | %X" )"
echo -e "${BLUE}• Current Domain      = $( cat /etc/xray/domain )"
echo -e "${BLUE}• Server IP           = $MYIP"
echo -e "${BLUE}• ISP                 = $(curl -s ipinfo.io/org | cut -d " " -f 2-10 )${NC}"
echo -e "${BLUE}• Status Hari ini     = $(cat /root/status)${NC}"
echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
...
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}│ ${YELLOW}${BLUE}👉ID CLIENT  >> ${RED}$Name                           ${NC}"
echo -e "${BLUE}│ ${YELLOW}${BLUE}👉REMAINING  >> ${RED}$left HARI | $Exp        ${NC}"
echo -e "${BLUE}│ ${YELLOW}${BLUE}👉DEVELOVER  >> ${RED}CANDRA SCRIPT TUNNEL              ${NC}"
echo -e "${BLUE}│ ${YELLOW}${BLUE}👉VERSION    >> ${RED}V 1.3 MOD SCRIPT                         ${NC}"
echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e ""
echo
